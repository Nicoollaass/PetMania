 ...
 * @author Nicolas
 */
public class RelatorioVendedor implements  Logica {
    ...
    public String executa(HttpServletRequest req, HttpServletResponse res, String method) throws Exception {
        ...
        int id_vendedor = new Utils().parseStringInt(req.getParameter("id_vendedor"));
        List<Object> relatorioFiliais =  relatorio.vendedor(id_vendedor);
